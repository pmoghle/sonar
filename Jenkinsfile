  ...
  stages {
   ...
   stage('Building image') {
    ...
    stage('Deploy Image in to nexus registry') {
      steps{
        script {
	  sh 'docker tag flask 2.66.207.155:8083/repository/docker-grp/flask'
	  sh ' docker login -u admin -p pooja 52.66.207.155:8083/repository/docker-grp/' 
          sh ' docker push 2.66.207.155:8083/repository/docker-grp/flask'
          sh ' docker logout 2.66.207.155:8083/repository/docker-grp/'
